...
const LEAVE_TYPES = [
  ...
  { code: "Co+", name: "Compensatory Duty (days added)", color: "#F5A623", quotaGroup: null, quotaWeight: 1, sortOrder: 8 },
  { code: "C-", name: "Compensation Leave (taken)", color: "#3FA9F5", quotaGroup: null, quotaWeight: 1, sortOrder: 9 },
